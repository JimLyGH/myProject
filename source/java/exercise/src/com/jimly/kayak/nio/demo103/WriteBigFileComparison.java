...
public class WriteBigFileComparison {
	...
	public static void main(String[] args) throws IOException {
		System.out.println("##########	writeWithFileChannel	##########");
		writeWithFileChannel();
		
		System.out.println("##########	writeWithTransferTo	##########");
		writeWithTransferTo();
		
		System.out.println("##########	writeWithMappedByteBuffer	##########");
